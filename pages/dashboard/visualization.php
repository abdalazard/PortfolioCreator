                            ...
                            <?php foreach ($skills as $skill) { ?>
                                <li>
                                    <div id="image02" class="style2 image">
                                        <img src="<?php echo '../../' . $skill['skill']; ?>" alt="Stacks" widht="50px" height="50px" />
                                    </div>
                                </li>
                            <?php } ?>
                        </ul>
                        ...
                        <div class="inner" data-onvisible-trigger="1">
                            ...
                            <ul id="buttons04" class="style1 buttons">
                                <?php foreach ($others as $other) { ?>
                                    <li>
                                        <a href="#modal<?php echo $other['id']; ?>" class="button n01 waves-effect waves-light btn modal-trigger">
                                            <svg>
                                                <use xlink:href="#icon-49c7b76f0edfabe10e324ba1ac396f84"></use>
                                            </svg>
                                        </a>
                                    ...
                                    <div id="modal<?php echo $other['id']; ?>" name="modal<?php echo $other['id']; ?>" class="modal modal-fixed-footer">
                                        <div class="modal-content">
                                            <h4><?php echo $other['tema']; ?></h4>
                                            <img src=<?php echo '../../' . $other['banner']; ?> widht="250px" height="450px" />
                                        </div>
